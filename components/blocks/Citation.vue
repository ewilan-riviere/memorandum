...
-->
  <section class="py-6 overflow-hidden bg-gray-50 md:py-10 lg:py-12">
        ...
        <blockquote class="mt-8">
          ...
          >
            <p class="italic">
              &laquo;<span
                class="px-2"
                v-html="getRandomCitation(person.citations)"
              ></span
              >&raquo;
            </p>
          </div>
          <footer class="mt-8">
            <div class="md:flex md:items-center md:justify-center">
              <div class="md:flex-shrink-0">
                <img class="w-10 h-10 mx-auto rounded-full" :src="user.photo" />
              </div>
              <div
              ...
              >
                ...
                <svg
                  class="hidden w-5 h-5 mx-1 text-blue-useweb md:block"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
...
export default {
  ...
  mounted() {
    this.user = this.$formatUser(this.person)
  },
  methods: {
    getRandomCitation(citations) {
      const randomCitation = this.$shuffle(citations)

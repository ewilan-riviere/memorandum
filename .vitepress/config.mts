...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:image', content: 'https://memorandum.ewilan-riviere.com/og.png' }],
    ['meta', { property: 'og:description', content: 'Personal documentation and notes' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:locale', content: 'en' }],
    ['meta', { property: 'og:url', content: 'https://memorandum.ewilan-riviere.com' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: 'https://memorandum.ewilan-riviere.com/og.png' }],

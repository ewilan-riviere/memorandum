...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            <h3 class="mb-4 text-center">{{ trans('backpack::base.login') }}</h3>
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input
                                    ...
                                    name="{{ $username }}"
                                    value="{{ config('app.env') === 'local' ? config('app.admin_mail') : old($username) }}"
                                    id="{{ $username }}"
                                >
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input
                                    ...
                                    name="password"
                                    value="{{ config('app.env') === 'local' ? config('app.admin_password') : '' }}"
                                    id="password"
                                >
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input
                                            type="checkbox"
                                            name="remember"
                                            checked="{{ config('app.env') === 'local' ? true : false }}"
                                        >

...
<code-info ext="php" path="app/helpers.php">
...
<code-info ext="json" path="composer.json">
```json
{
  "name": "...",
  "require": {
...
<code-info ext="svg" path="resources/svg/github.svg">
```html
...
<code-info ext="blade" path="resources/views/welcome.blade.php">
```html
<style>
.my-auto {
  margin: auto 0;

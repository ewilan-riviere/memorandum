...
<code-info ext="env" path="/home/user/deploy/.env"></code-info>
```
PORT=3000
WEBHOOK_PATH=/deploy
WEBSCRIPT_PATH=
...
<code-info ext="json" path="/home/user/deploy/repositories.json"></code-info>
```json
{
    "remote-repo": [
            "local-repo"
...
<code-info ext="nginx" path="/etc/nginx/sites-available/default"></code-info>
```nginx{2,6,17,18}
server {
...
<code-info ext="sh" path="/home/user/www/portfolio-front/.git/hooks/post-merge"></code-info>
```sh
#!/bin/bash
